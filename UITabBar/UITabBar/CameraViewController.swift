...
class CameraViewController: UIViewController {
    ...
    @objc func prevButton(sender: UIButton) {
        ...
        titleLabel.text = Data.formatSteps[index]
        picImage.image = Data.formatImages[index]
        textView.text = Data.formatTitles[index]
        nextButton.isHidden = false
        prevButton.isHidden = (index == Data.formatImages.startIndex) ? true : false
    ...
    @objc func nextButton(sender: UIButton) {
        ...
        nextButton.isHidden = (index == Data.formatImages.endIndex-1) ? true : false
